        ...
        <div class="container col-sm-3" id="right-side-container">
            ...
            <div class="row" id="row2">
                <div id="purchase-display">
                    ...
                    <br>
                    <center>
                        <sf:form class="form-inline" role="form" modelAttribute="item"
                            ...
                            <br>
                            <div align="center">
                                <input type="submit" class="btn btn-default" id="purchase-button" value="Purchase Item">
            ...
            <div class="row" id="row3">
                <div id="change-display">
                    ...
                    <div align="center">
                        <a href="clearChange">
                            <input type="submit" class="btn btn-default" id="change-button" value="Change Return">
                            <!--                        possibly no?-->
